...
![Autenticación de Usuario y Recuperación de Contraseña](images/mobile-wireflow-1.png)

#### User goal: Manejo de Recursos
![Manejo de Recursos](images/mobile-wireflow-2.png)

#### User goal: Alquiler de maquinaria
![Alquiler de maquinaria](images/mobile-wireflow-3.png)

#### User goal: Alquiler de terreno
![Alquiler de terreno](images/mobile-wireflow-4.png)

#### User goal: Manejo de grupos
![Manejo de grupos](images/mobile-wireflow-5.png)

#### User goal: Manejo de documentos
![Manejo de documentos](images/mobile-wireflow-6.png)

#### User goal: Ajuste de datos personales, configuración de accesibilidad, cambio de contraseña
![Ajuste de datos personales](images/mobile-wireflow-7.png)
...
#### User goal: Manejo de Recursos
![Manejo de Recursos](images/mobile-userflow-5.png)
...
#### User goal: Alquiler de maquinaria
![Alquiler de maquinaria](images/mobile-userflow-6.png)
...
#### User goal: Alquiler de terreno
![Alquiler de terreno](images/mobile-userflow-7.png)
...
#### User goal: Manejo de grupos
![Manejo de grupos](images/mobile-userflow-8.png)
­
**Descripción:**
...
#### User goal: Manejo de documentos
![Manejo de documentos](images/mobile-userflow-9.png)
...
![Ajustes Personales](images/mobile-userflow-10.png)
...
#### User goal: Autenticación de Usuario y Recuperación de Contraseña.
![Autenticación de Usuario y Recuperación de Contraseña](images/web-userflow-1.png)
...
#### User goal: Navegación a través de la aplicación
![Navegación a través de la aplicación](images/web-userflow-2.png)
...
#### User goal: Manejo de Recursos
![Manejo de Recursos](images/web-userflow-3.png)

**Descripción:**
> El usuario ingresa a la sección de gestión de recursos. Si desea añadir un recurso, puede crearlo registrando todos los datos del nuevo recurso que se piden. Si desea añadir un nuevo campo, editar el recurso o eliminarlo, puede hacerlo en la sección opciones.

#### User goal: Alquiler de maquinaria
![Alquiler de maquinaria](images/web-userflow-4.png)

**Descripción:**
> El usuario ingresa a la sección de maquinaria. Si desea alquilar alguna maquinaria podrá hacerlo eligiendo cual maquinaria desea. Si completa el tramite y completa los datos de pago correctamente la compra finalizara

#### User goal: Alquiler de terreno
![Alquiler de terreno](images/web-userflow-5.png)
...
#### User goal: Manejo de grupos
![Manejo de grupos](images/web-userflow-6.png)
­
**Descripción:**
> En esta sección, se le permitirá al usuario crear grupos, así como agregar, editar y eliminar integrantes de este. Al principio, no existirá ningún grupo. Cuando el usuario cree uno, proporcionando un nombre, se mostrará una tabla vacía, en donde se pondrán agregar nuevos integrantes.

#### User goal: Manejo de documentos
![Manejo de documentos](images/web-userflow-7.png)

**Descripción:**
> En esta sección, se le permitirá al usuario crear, editar y eliminar documentos de una carpeta de documentos.

#### User goal: Ajuste de datos personales
![Ajustes Personales](images/web-userflow-8.png)
